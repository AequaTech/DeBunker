...
class Danger():
    ...
    def prediction(self, url):
        res = {
            'stereotype': self.classification(url.feat_title, url.attention_title, task='stereo'),
            #'flame':      self.classification(url.feat_title, url.attention_title, task='flame'),
            #'irony':      self.classification(url.feat_title, url.attention_title, task='iro'),
            #'sarcasm':    self.classification(url.feat_title, url.attention_title, task='sarc')
              }
